...
export function Footer() {
  return (
    <footer className="w-full border-t border-gray-200 dark:border-[#171717] bg-white dark:bg-black">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand Section */}
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-extrabold mb-3">
              Code<span className="text-orange-500">Daddy</span>
            </h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
              AI-powered code reviews built for teams who move fast.
            </p>
          </div>
        ...
        {/* Bottom Section */}
        <div className="pt-8 border-t border-gray-200 dark:border-[#171717] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            © 2025 CodeDaddy. All rights reserved.
          </p>
          ...
          <div className="flex gap-4">
            <a
              href="https://github.com/hemanth-1321/codeDaddy"
              target="_blank"
